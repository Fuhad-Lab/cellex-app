...
export default function LivePage() {
  ...
  const [liveNow, setLiveNow] = usePersistedState<any[]>('live:liveNow', []);
  const [recent, setRecent] = usePersistedState<any[]>('live:recent', []);
  const [loading, setLoading] = useState(liveNow.length === 0);
