...
export default function SellerAcademyPage() {
  return (
    <div className="space-y-6">
      ...
      {/* Coming soon hero */}
      <div className="border border-white/10 rounded-md p-8 text-center bg-neutral-50">
        ...
        <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-medium text-neutral-500 bg-white px-3 py-1.5 rounded-full border border-white/10">
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {upcomingCourses.map((course) => {
            ...
            return (
              <div key={course.title} className="border border-white/10 rounded-md p-4 bg-white hover:bg-neutral-50 transition-colors">
      ...
      {/* Notify me */}
      <div className="border border-white/10 rounded-md p-5 text-center bg-white">
        <p className="text-sm text-neutral-600 mb-3">
          Want to be the first to know when courses launch?
        </p>
        <button
          disabled
          className="bg-white border border-white/15 text-neutral-400 font-semibold rounded-md px-4 py-2 text-sm cursor-not-allowed inline-flex items-center gap-2"
        >
