...
function LoginContent() {
  ...
  // Support ?mode=signup so the "Sign up" button in the header can deep-link here.
              ...
              <>
                ...
                <div className="flex flex-col items-center gap-2 pb-2">
                  <button
                    ...
                    className="relative w-24 h-24 rounded-full bg-[#F5F5F5] border-2 border-dashed border-white/15 hover:border-[#E5E5E5] hover:bg-[#374151] transition-colors flex items-center justify-center overflow-hidden group"
