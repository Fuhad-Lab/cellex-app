    ...
    <div className="ig-container min-h-screen pb-32 ig-topbar-offset">
      ...
      <div className="px-4 py-4 space-y-6">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5 sm:col-span-2">
              ...
              <p className="text-[10px] text-neutral-400">Used to match your PalmPay transfer email — must match the bank you transfer from.</p>
            </div>
            <div className="space-y-1.5 sm:col-span-2">
        ...
        <section>
          ...
          <div className="border border-neutral-300 rounded-md p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-neutral-500">Pay via bank transfer — auto-verified within 30 seconds</div>
            </div>
        ...
        <section>
          ...
          <div className="space-y-2 mb-3">
            {items.map((item) => (
              <div key={item.id} className="flex gap-3 items-center">
                <div className="w-10 h-10 rounded-md bg-neutral-50 overflow-hidden shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[10px] text-neutral-500">Qty {item.quantity} · {formatPrice(item.products?.price || 0)}</div>
                </div>
              </div>
            ))}
          </div>
          <div className="space-y-1.5 text-sm border-t border-neutral-100 pt-3">
            ...
            <div className="flex justify-between font-bold pt-1 border-t border-neutral-100">
              <span>Total</span>
